...
class fileuploader {
    ...
    public function getName(){
        if (isset($_REQUEST['qqfilename']))
            return preg_replace('/[^a-zA-Z0-9\-\_\.]/siU','-',$_REQUEST['qqfilename']);

        if (isset($_FILES[$this->inputName]))
            return preg_replace('/[^a-zA-Z0-9\-\_\.]/siU','-',$_FILES[$this->inputName]['name']);
    }
    ...
    public function getSize(){
        if (isset($_REQUEST['qqfilesize']))
            return $_REQUEST['qqfilesize'];
    ...
    public function handleUpload($uploadDirectory, $name = null){
        ...
        if ($totalParts > 1){
            ...
            if ($success AND ($totalParts-1 == $partIndex)){
                ...
                $this->uploadName = preg_replace('/[^a-zA-Z0-9\-\_\.]/siU','-',basename($target));
